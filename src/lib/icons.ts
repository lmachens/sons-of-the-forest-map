...
export function getIconSVG(type: NodeType, color = "currentColor", size = 30) {
  ...
  return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="${color}" stroke="#000" d="${PIN_PATH}"/><path d="${type.icon}" fill="#fff" fill-opacity="1" stroke="#000000" stroke-opacity="1" stroke-width="1%" filter="url(#shadow-1)"></path></svg>';
}
